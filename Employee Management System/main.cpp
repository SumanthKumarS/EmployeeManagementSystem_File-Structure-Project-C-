...
void borderMain(int xLenS = 2, int yLenS = 2,int xLenE = 76, int yLenE = 22){
...
void login()
{
    ...
    else
    {
         ...
         if(countlog<2){
             ...
             int xLenS = 2,yLenS = 2,xLenE = 76, yLenE = 24;
             borderNoDelay(xLenS,yLenS,xLenE, yLenE);
             gotoXY(21,10);
             printf("You have Entered Too many time!!!\a");
             gotoXY(12,12);
             cout<<"Invalid Credentials Process Will Be Terminated in 3 Seconds...";
             gotoXY(56,12);
             Cdelay(1000);
             gotoXY(44,12);
             cout<<"\b \b2";
...
int main()
{
    int xLenS = 18,yLenS = 8,xLenE = 55, yLenE = 15;
    setWindowSize();
    border();
    borderMain(xLenS,yLenS,xLenE, yLenE);
    intro();
    loading();
    loginFrame();
    login();
